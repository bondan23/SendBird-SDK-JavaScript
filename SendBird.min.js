...
if(n)return void(i&&i(null,n));if(e.isHidden=!1,w.cachedChannels[e.url]=e,h._sender&&e.memberMap.hasOwnProperty(h._sender.userId)){var r=e.memberMap[h._sender.userId];r.nickname!==h._sender.nickname&&(r.nickname=h._sender.nickname),r.profileUrl!==h._sender.profileUrl&&(r.profileUrl=h._sender.profileUrl)}
var a=ie.getInstance().currentUser;if(a&&h._sender&&a.userId===h._sender.userId&&(a.nickname!==h._sender.nickname&&(a.nickname=h._sender.nickname),a.profileUrl!==h._sender.profileUrl&&(a.profileUrl=h._sender.profileUrl)),I||(e.isEphemeral?(e.lastMessage=h,h.sender&&h.sender.userId===ie.getInstance().getCurrentUserId()||e.unreadMessageCount++):p&&(e.updatedLocal?(e.lastMessage=h,h.sender&&h.sender.userId===ie.getInstance().getCurrentUserId()||e.unreadMessageCount++):(!e.lastMessage||e.lastMessage.createdAt<h.createdAt)&&(e.updatedLocal=!0,e.lastMessage=h,h.sender&&h.sender.userId===ie.getInstance().getCurrentUserId()||e.unreadMessageCount++))),!I)
for(var s in ie.getInstance().channelHandlers){var o=ie.getInstance().channelHandlers[s];o.onChannelChanged(e)}
var l=!1;for(var s in h.mentionedUsers)
if(h.mentionedUsers[s].userId===ie.getInstance().getCurrentUserId()){l=!0;break}
for(var s in ie.getInstance().channelHandlers){var o=ie.getInstance().channelHandlers[s];o.onMessageReceived(e,h),l&&o.onMentionReceived(e,h)}})}else b.getChannel(h.channelUrl,function(e,n){if(R){var t=e;e=n,n=t}
if(n)return void(i&&i(null,n));var r=!1;for(var a in h.mentionedUsers)
if(h.mentionedUsers[a].userId===ie.getInstance().getCurrentUserId()){r=!0;break}
for(var a in ie.getInstance().channelHandlers){var s=ie.getInstance().channelHandlers[a];b.enteredChannels[e.url]&&s.onMessageReceived(e,h),r&&s.onMentionReceived(e,h)}});break;case "MEDI":case "FEDI":case "AEDI":var h="";if(!(h="MEDI"===t.command?new O(t.getJsonElement()):"FEDI"===t.command?new D(t.getJsonElement()):new L(t.getJsonElement())))return;h.isGroupChannel()?w.getChannel(h.channelUrl,function(e,n){if(R){var t=e;e=n,n=t}
if(n)return void(i&&i(null,n));if(h._sender&&e.memberMap.hasOwnProperty(h._sender.userId)){var r=e.memberMap[h._sender.userId];r.nickname!==h._sender.nickname&&(r.nickname=h._sender.nickname),r.profileUrl!==h._sender.profileUrl&&(r.profileUrl=h._sender.profileUrl)}
var a=ie.getInstance().currentUser;a&&h._sender&&a.userId===h._sender.userId&&(a.nickname!==h._sender.nickname&&(a.nickname=h._sender.nickname),a.profileUrl!==h._sender.profileUrl&&(a.profileUrl=h._sender.profileUrl));for(var s in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[s].onMessageUpdated(e,h)}}):b.getChannel(h.channelUrl,function(e,n){if(R){var t=e;e=n,n=t}
if(n)return void(i&&i(null,n));for(var r in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[r].onMessageUpdated(e,h)}});break;case "READ":var E=new F(t.getJsonElement()),p=w.cachedChannels.hasOwnProperty(E.channelUrl);w.getChannel(E.channelUrl,function(e,n){if(R){var t=e;e=n,n=t}
if(n)return void(i&&i(null,n));if(E.reader.userId===ie.getInstance().getCurrentUserId()){if(p){if(e.unreadMessageCount>0){e.unreadMessageCount=0;for(var r in ie.getInstance().channelHandlers){var a=ie.getInstance().channelHandlers[r];a.onChannelChanged(e)}}}else if(0===e.unreadMessageCount)
for(var r in ie.getInstance().channelHandlers){var a=ie.getInstance().channelHandlers[r];a.onChannelChanged(e)}}else{e.updateReadReceipt(E.reader.userId,E.timestamp);for(var r in ie.getInstance().channelHandlers){var a=ie.getInstance().channelHandlers[r];a.onReadReceiptUpdated(e)}}});break;case "TPST":case "TPEN":case "MTIO":break;case "SYEV":c(t);break;case "USEV":u(t);break;case "DELM":var f=t.getJsonElement(),A=String(f.channel_type),g=String(f.channel_url),m=String(f.msg_id);switch(A){case M.CHANNEL_TYPE_OPEN:b.getChannel(g,function(e,t){if(R){var r=e;e=t,t=r}
if(t)return void n.log("Discard a command.");for(var i in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[i].onMessageDeleted(e,m)}});break;case M.CHANNEL_TYPE_GROUP:w.getChannel(g,function(e,t){if(R){var r=e;e=t,t=r}
if(t)return void n.log("Discard a command.");for(var i in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[i].onMessageDeleted(e,m)}})}}},u=function(e){var n=new H(e.getJsonElement());switch(n.category){case k.CATEGORY_USER_BLOCK:case k.CATEGORY_USER_UNBLOCK:var t=n.data.blocker.user_id,r=n.data.blockee.user_id;Object.keys(w.cachedChannels).forEach(function(e){var i=w.cachedChannels[e];try{ie.getInstance().getCurrentUserId()===t?i.memberMap[r].isBlockedByMe=n.category===k.CATEGORY_USER_BLOCK:ie.getInstance().getCurrentUserId()===r&&(i.memberMap[t].isBlockingMe=n.category===k.CATEGORY_USER_BLOCK)}catch(e){}});break;case k.CATEGORY_FRIEND_DISCOVERED:var i=n.data.friend_discoveries,a=i.map(function(e){return new G(e)});for(var s in ie.getInstance().userEventHandlers){ie.getInstance().userEventHandlers[s].onFriendsDiscovered(a)}}},c=function(e){var t=new H(e.getJsonElement());switch(t.category){case H.CATEGORY_CHANNEL_JOIN:case H.CATEGORY_CHANNEL_LEAVE:w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=new G(t.data);if(t.category===H.CATEGORY_CHANNEL_JOIN){t.data.state=V.JOINED,r.addMember(new V(t.data)),s.userId===ie.getInstance().getCurrentUserId()&&(r.myMemberState="joined",w.cachedChannels[r.url]=r);for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserJoined(r,s)}}else{s.userId===ie.getInstance().getCurrentUserId()&&(r.isPublic||w.removeCachedChannel(t.channelUrl));r.removeMember(s);r.myMemberState="none",w.cachedChannels[r.url]=r;for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserLeft(r,s)}}});break;case H.CATEGORY_CHANNEL_INVITE:w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=null;t.data&&t.data.inviter&&!d(t.data.inviter)&&(s=new G(t.data.inviter));var o=[];for(var l in t.data.invitees){t.data.invitees[l].state=V.INVITED;var u=new V(t.data.invitees[l]);o.push(u),r.addMember(u),u.userId===ie.getInstance().getCurrentUserId()&&(r.isHidden=!1,"joined"!==r.myMemberState&&(r.myMemberState="invited"),w.cachedChannels[r.url]=r)}
for(var l in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[l].onUserReceivedInvitation(r,s,o)}});break;case H.CATEGORY_CHANNEL_DECLINE_INVITE:w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=null;t.data&&t.data.inviter&&!d(t.data.inviter)&&(s=new G(t.data.inviter));var o=new G(t.data.invitee);o.userId===ie.getInstance().getCurrentUserId()&&(r.isPublic||w.removeCachedChannel(t.channelUrl)),r.removeMember(o),r.myMemberState="none",w.cachedChannels[r.url]=r;for(var l in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[l].onUserDeclinedInvitation(r,s,o)}});break;case H.CATEGORY_TYPING_START:case H.CATEGORY_TYPING_END:w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=new G(t.data);t.category===H.CATEGORY_TYPING_START?r.updateTypingStatus(s,!0):r.updateTypingStatus(s,!1);for(var o in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[o].onTypingStatusUpdated(r)}});break;case H.CATEGORY_CHANNEL_ENTER:case H.CATEGORY_CHANNEL_EXIT:b.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);t.data.hasOwnProperty("participant_count")&&(r.participantCount=t.data.participant_count);var s=new G(t.data);if(t.category===H.CATEGORY_CHANNEL_ENTER)
for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserEntered(r,s)}else for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserExited(r,s)}});break;case H.CATEGORY_USER_CHANNEL_MUTE:case H.CATEGORY_USER_CHANNEL_UNMUTE:t.isOpenChannel()?b.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=new G(t.data);if(t.category===H.CATEGORY_USER_CHANNEL_MUTE)
for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserMuted(r,s)}else for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserUnmuted(r,s)}}):w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=new G(t.data);if(t.category===H.CATEGORY_USER_CHANNEL_MUTE)
for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserMuted(r,s)}else for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserUnmuted(r,s)}});break;case H.CATEGORY_USER_CHANNEL_BAN:case H.CATEGORY_USER_CHANNEL_UNBAN:t.isOpenChannel()?b.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=new G(t.data);if(t.category===H.CATEGORY_USER_CHANNEL_BAN)
for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserBanned(r,s)}else for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserUnbanned(r,s)}}):w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);var s=new G(t.data);if(t.category===H.CATEGORY_USER_CHANNEL_BAN)
for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserBanned(r,s)}else for(var o in ie.getInstance().channelHandlers){var l=ie.getInstance().channelHandlers[o];l.onUserUnbanned(r,s)}});break;case H.CATEGORY_CHANNEL_FREEZE:case H.CATEGORY_CHANNEL_UNFREEZE:t.isOpenChannel()?b.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);if(r.isFrozen=t.data.freeze,b.cachedChannels[r.url]=r,t.category===H.CATEGORY_CHANNEL_FREEZE)
for(var s in ie.getInstance().channelHandlers){var o=ie.getInstance().channelHandlers[s];o.onChannelFrozen(r)}else for(var s in ie.getInstance().channelHandlers){var o=ie.getInstance().channelHandlers[s];o.onChannelUnfrozen(r)}}):w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);if(r.isFrozen=t.data.freeze,w.cachedChannels[r.url]=r,t.category===H.CATEGORY_CHANNEL_FREEZE)
for(var s in ie.getInstance().channelHandlers){var o=ie.getInstance().channelHandlers[s];o.onChannelFrozen(r)}else for(var s in ie.getInstance().channelHandlers){var o=ie.getInstance().channelHandlers[s];o.onChannelUnfrozen(r)}});break;case H.CATEGORY_CHANNEL_DELETED:if(t.isGroupChannel()){w.removeCachedChannel(t.channelUrl);for(var r in ie.getInstance().channelHandlers){var i=ie.getInstance().channelHandlers[r];i.onChannelDeleted(t.channelUrl,"group")}}else{b.removeCachedChannel(t.channelUrl);for(var r in ie.getInstance().channelHandlers){var i=ie.getInstance().channelHandlers[r];i.onChannelDeleted(t.channelUrl,"open")}}
break;case H.CATEGORY_CHANNEL_PROP_CHANGED:t.isOpenChannel()?b.getChannelWithoutCache(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);for(var s in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[s].onChannelChanged(r)}}):w.getChannelWithoutCache(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);for(var s in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[s].onChannelChanged(r)}});break;case H.CATEGORY_CHANNEL_META_DATA_CHANGED:case H.CATEGORY_CHANNEL_META_COUNTERS_CHANGED:var a=t.data.hasOwnProperty("created"),s=t.data.hasOwnProperty("updated"),o=t.data.hasOwnProperty("deleted");t.isOpenChannel()?b.getChannel(t.channelUrl,function(r,i){if(R){var l=r;r=i,i=l}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);for(var u in ie.getInstance().channelHandlers){var c=ie.getInstance().channelHandlers[u];t.category===H.CATEGORY_CHANNEL_META_DATA_CHANGED?(a&&c.onMetaDataCreated(r,t.data.created),s&&c.onMetaDataUpdated(r,t.data.updated),o&&c.onMetaDataDeleted(r,t.data.deleted)):(a&&c.onMetaCountersCreated(r,t.data.created),s&&c.onMetaCountersUpdated(r,t.data.updated),o&&c.onMetaCountersDeleted(r,t.data.deleted))}}):w.getChannel(t.channelUrl,function(r,i){if(R){var l=r;r=i,i=l}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);for(var u in ie.getInstance().channelHandlers){var c=ie.getInstance().channelHandlers[u];t.category===H.CATEGORY_CHANNEL_META_DATA_CHANGED?(a&&c.onMetaDataCreated(r,t.data.created),s&&c.onMetaDataUpdated(r,t.data.updated),o&&c.onMetaDataDeleted(r,t.data.deleted)):(a&&c.onMetaCountersCreated(r,t.data.created),s&&c.onMetaCountersUpdated(r,t.data.updated),o&&c.onMetaCountersDeleted(r,t.data.deleted))}});break;case H.CATEGORY_CHANNEL_HIDE:w.getChannel(t.channelUrl,function(r,i){if(R){var a=r;r=i,i=a}
if(i)return void n.log("Discard a command: "+e.command+":"+t.category);if(r.isHidden=!0,t.data&&t.data.hasOwnProperty("hide_previous_messages")&&t.data.hide_previous_messages&&w.cachedChannels){var s=w.cachedChannels[r.url];s.unreadMessageCount=0,w.cachedChannels[r.url]=s}
for(var o in ie.getInstance().channelHandlers){ie.getInstance().channelHandlers[o].onChannelHidden(r)}})}};this.setPushTemplate=function(e,n){return!e||e!==this.PUSH_TEMPLATE_DEFAULT&&e!==this.PUSH_TEMPLATE_ALTERNATIVE?void U(null,new _("Invalid arguments.",J.INVALID_PARAMETER),n):this.currentUser?void Z.getInstance().setPushTemplate(this.getCurrentUserId(),e,function(e,t){if(t)return void U(null,t,n);var r=e.name.toString();U(r,null,n)}):void U(null,new _("Connection must be made before you set push template",J.CONNECTION_REQUIRED),n)},this.getPushTemplate=function(e){if(!this.currentUser)return void U(null,new _("Connection must be made before you get push template",J.CONNECTION_REQUIRED),e);Z.getInstance().getPushTemplate(this.getCurrentUserId(),function(n,t){if(t)return void U(null,t,e);var r=n.name.toString();U(r,null,e)})},this.setChannelInvitationPreference=function(e,n){"boolean"!=typeof e&&U(null,new _("Invalid arguments.",J.INVALID_PARAMETER),n),Z.getInstance().setChannelInvitationPreference(this.getCurrentUserId(),e,function(e,t){if(t)return void U(null,t,n);U({autoAccept:e.auto_accept},null,n)})},this.getChannelInvitationPreference=function(e){Z.getInstance().getChannelInvitationPreference(this.getCurrentUserId(),function(n,t){if(t)return void U(null,t,e);U({autoAccept:n.auto_accept},null,e)})},this.connect=function(){var e=Array.prototype.slice.call(arguments),r=null,i=null,a=null;switch("function"==typeof e.slice(-1)[0]&&(a=e.pop()),e.length){case 1:r=e[0];break;case 2:r=e[0],i=e[1];break;case 3:r=e[0],this.customApiHost=e[1],this.customWsHost=e[2];break;case 4:r=e[0],i=e[1],this.customApiHost=e[2],this.customWsHost=e[3];break;default:t&&n.log("sb.connect args length error: ",arguments)}
